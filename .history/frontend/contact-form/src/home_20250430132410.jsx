    ...
    >
     ...
     <a href="https://github.com/Mahanandapadavale123" target="_blank" rel="noreferrer">
      ...
      <div className="main_right">
        <img src="D:\Projects\portfolio\frontend\contact-form\src\img\employee working laptop girl images like icon - Google Search_files\girl-laptop-icon-flat-style-woman-freelance-working-vector-illustration-isolated-background-student-workplace-sign-272939409.jpg" alt="Mahananda Padavale" className="main_img" />
        </div>
    </motion.div>
  );
}
