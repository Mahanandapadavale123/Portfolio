...
import { faPhone, faEnvelope } from "@fortawesome/free-solid-svg-icons"; // ✅ Add missing imports
...
const ContactForm = () => {
  ...
  return (
          ...
          <ul className="contact-list">
            <li className="list-item">
              ...
              <span className="contact-text phone">
                <a href="tel:9175226646" title="Give me a call">
                  +91-9175226646
                </a>
              </span>
            </li>
            <li className="list-item">
              ...
              <span className="contact-text gmail">
                <a href="mailto:vamsipraneeth2004@gmail.com" title="Send me an email">
                  mahanandapadavale252@gmail.com
                </a>
              </span>
            </li>
          </ul>
    ...
    </motion.div> // ✅ Closing motion.div properly
  );
};
